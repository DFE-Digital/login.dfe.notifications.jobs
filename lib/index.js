...
const register = (config, logger) => {
  ...
  const unmigratedSaUserHandler = secondFactor.register(config, logger);
  return union(inviteHandlers, passwordResetHandlers, supportHandlers, registrationHandlers, confirmMigratedEmailHandlers, changeProfileHandlers, accessRequestHandler, secondFactorHandler, unmigratedSaUserHandler);
};
