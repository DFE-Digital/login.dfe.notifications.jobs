...
const register = (config, logger) => {
  ...
  return union(inviteHandlers, passwordResetHandlers, supportHandlers, registrationHandlers, confirmMigratedEmailHandlers, changeProfileHandlers, accessRequestHandler, secondFactorHandler);
};
