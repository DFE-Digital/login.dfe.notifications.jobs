jest.mock('./../../../lib/handlers/support/supportRequestV1');
...
describe('when registering support handlers', () => {
  let v1;
  let register;

  beforeAll(() => {
    v1 = require('./../../../lib/handlers/support/supportRequestV1');
    v1.getHandler = jest.fn().mockReturnValue({
      type: 'v1',
      processor,
    });

    register = require('./../../../lib/handlers/support').register;
  });
