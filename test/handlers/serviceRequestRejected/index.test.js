jest.mock('./../../../lib/handlers/serviceRequestRejected/rejectServiceV1');
...
describe('when registering service request rejected handlers', () => {
  let v1;
  let register;

  beforeAll(() => {
    v1 = require('./../../../lib/handlers/serviceRequestRejected/rejectServiceV1');
    v1.getHandler = jest.fn().mockReturnValue({
      type: 'v1',
      processor,
    });

    register = require('./../../../lib/handlers/serviceRequestRejected').register;
  });
