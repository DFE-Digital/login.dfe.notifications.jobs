jest.mock('./../../../lib/handlers/changeProfile/verifyChangeEmailV1');
...
describe('when registering change profile handlers', () => {
  ...
  beforeAll(() => {
    verifyChangeEmailV1 = require('./../../../lib/handlers/changeProfile/verifyChangeEmailV1');
    verifyChangeEmailV1.getHandler = jest.fn().mockReturnValue({
      type: 'verifyChangeEmailV1',
      processor,
    });

    register = require('./../../../lib/handlers/changeProfile').register;
  });
