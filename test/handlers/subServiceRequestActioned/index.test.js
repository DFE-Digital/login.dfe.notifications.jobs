...
describe('when registering subServiceRequestActioned handlers', () => {
  ...
  beforeAll(() => {
    subServiceRequestApproved = require('../../../lib/handlers/subServiceRequestActioned/subServiceRequestApproved');
    subServiceRequestApproved.getHandler = jest.fn().mockReturnValue({
      type: 'sub_service_request_approved',
      processor,
    });

    subServiceRequestRejected = require('../../../lib/handlers/subServiceRequestActioned/subServiceRequestRejected');
    subServiceRequestRejected.getHandler = jest.fn().mockReturnValue({
      type: 'sub_service_request_rejected',
      processor,
    });

    register = require('../../../lib/handlers/subServiceRequestActioned').register;
  });
