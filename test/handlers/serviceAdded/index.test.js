jest.mock('./../../../lib/handlers/serviceAdded/newServiceAddedV1');
...
describe('when registering service added handlers', () => {
  ...
  beforeAll(() => {
    v1 = require('./../../../lib/handlers/serviceAdded/newServiceAddedV1');
    v1.getHandler = jest.fn().mockReturnValue({
      type: 'v1',
      processor,
    });

    register = require('./../../../lib/handlers/serviceAdded').register;
  });
