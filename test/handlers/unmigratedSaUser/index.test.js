jest.mock('./../../../lib/handlers/unmigratedSaUser/unmigratedSaUserV1');
...
describe('when registering unmigrated SA User handlers', () => {
  let v1;
  let register;

  beforeAll(() => {
    v1 = require('./../../../lib/handlers/unmigratedSaUser/unmigratedSaUserV1');
    v1.getHandler = jest.fn().mockReturnValue({
      type: 'v1',
      processor,
    });

    register = require('./../../../lib/handlers/unmigratedSaUser').register;
  });
