jest.mock('./../../../lib/handlers/passwordReset/passwordResetV1');
...
describe('when registering invite handlers', () => {
  ...
  beforeAll(() => {
    v1 = require('./../../../lib/handlers/passwordReset/passwordResetV1');
    v1.getHandler = jest.fn().mockReturnValue({
      type: 'v1',
      processor,
    });

    register = require('./../../../lib/handlers/passwordReset').register;
  });
