...
describe('When sending sms using DiskAdapter', () => {
  ...
  beforeEach(() => {
    ...
    const DiskEmailAdapter = require('../../../lib/infrastructure/sms/DiskSmsAdapter');
  ...
  test('then it should write param to disk', async () => {
    ...
    expect(fsWriteFile.mock.calls[0][0]).toMatch(/\/temp\/app_data\/sms\/unit-tests\/[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}-[0-9]{2}-[0-9]{2}\.json/)
